...
def main():
    ...
    msn_transformations = Transformations()
    ...
    fire.Fire({
        ...
        'mesh_to_pointcloud': msn_transformations.mesh_to_pointcloud,
        'dataset_stl_to_npz': msn_transformations.dataset_stl_to_npz,
        'dataset_stl_to_pointcloud': msn_transformations.dataset_stl_to_pointcloud,
    })

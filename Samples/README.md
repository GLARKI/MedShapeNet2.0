...
| MedShapeNet 19 | [MedShapeNet_19_subset.ipynb](https://github.com/GLARKI/MedShapeNet2.0/blob/main/Samples/MedShapeNet_19_subset.ipynb)| Steps demonstrating how a task-optimized MedShapeNet subset can be created" ([Original repo of contributor](https://github.com/TomasKrsicka/MedShapeNet19-PSPooling))| Entire MedShapeNet 1.0 dataset |
